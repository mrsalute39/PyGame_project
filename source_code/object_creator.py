...
class ObjectHandler:
    def __init__(self, game):
        ...
        self.add_sprite(SpriteObject(game, path="data/sprites/props/main_hero_car.png", pos=(6.0, 1.5), scale=1.0,
                                     shift=0.3))
        self.add_sprite(
            SpriteObject(game, path="data/sprites/props/dead_body.png", pos=(11.5, 2.5), scale=0.75, shift=0.25))
        self.add_sprite(
            SpriteObject(game, path="data/sprites/props/last_table.png", pos=(31.5, 4.5), scale=0.6, shift=0.5))
        ...
        self.add_enemy(Trooper(game, pos=(31.5, 5.5), scale=0.75, shift=0.25))
        self.add_enemy(Trooper(game, pos=(34.5, 5.5), scale=0.75, shift=0.25))
        self.add_enemy(Trooper(game, pos=(28.5, 5.5), scale=0.75, shift=0.25))
        self.add_enemy(Trooper(game, pos=(28.5, 8.5), scale=0.75, shift=0.25))
        self.add_enemy(Trooper(game, pos=(31.5, 8.5), scale=0.75, shift=0.25))
        self.add_enemy(Trooper(game, pos=(33.5, 18.5), scale=0.75, shift=0.25))
        self.add_enemy(Trooper(game, pos=(28.5, 25.5), scale=0.75, shift=0.25))
        self.add_enemy(Trooper(game, pos=(31.5, 23.5), scale=0.75, shift=0.25))
        self.add_enemy(Trooper(game, pos=(35.5, 21.5), scale=0.75, shift=0.25))
        self.add_enemy(Trooper(game, pos=(31.5, 22.5), scale=0.75, shift=0.25))
        self.add_enemy(Trooper(game, pos=(31.5, 15.5), scale=0.75, shift=0.25))
        self.add_enemy(Trooper(game, pos=(35.5, 8.5), scale=0.75, shift=0.25))
        self.add_enemy(Trooper(game, pos=(28.5, 10.5), scale=0.75, shift=0.25))
        self.add_enemy(Trooper(game, pos=(35.5, 6.5), scale=0.75, shift=0.25))

        self.add_enemy(FastAsFuckBoi(game, pos=(29.5, 15.5)))
        self.add_enemy(FastAsFuckBoi(game, pos=(35.5, 10.5)))
        self.add_enemy(FastAsFuckBoi(game, pos=(33.5, 3.5)))
        self.add_enemy(FastAsFuckBoi(game, pos=(28.5, 3.5)))
        self.add_enemy(FastAsFuckBoi(game, pos=(35.5, 14.5)))
        self.add_enemy(FastAsFuckBoi(game, pos=(35.5, 25.5)))
